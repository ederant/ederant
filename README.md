...
- Configuración y administración de routers **MikroTik RouterOS** (PPPoE, VLANs, CAPsMAN, Queues)
...
- 🎓 Ing. en Sistemas de Computación — UNICAH
- ✅ Cisco Networking Academy — Networking Basics (2026)
- 📡 CCNA 1 
